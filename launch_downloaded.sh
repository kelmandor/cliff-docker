...
# cp /src/downloads/cliff-2.4.2.war /usr/local/tomcat/webapps/
...
# cp /src/downloads/allCountries.zip .
# cp -r /etc/cliff2/IndexDirectory/IndexDirectory .
...
echo "DONE:: building Lucene index of placenames (takes up to 20 mins)"
